...
public class ProjectsDaoImpl implements ProjectsDao {
    ...
    @Override
    public List<Project> findProjectByMc(String mc){
                Connection connection=SingletonConnexionDB.getConnection();
                List<Project>produits=new ArrayList<>();
                try{
                PreparedStatement pstm=connection.prepareStatement("select * from PROJECT where NAME like ?");
                pstm.setString(1,"%"+mc+"%");
